...
void aff_cote_Livre(maillon_Livre*p,int cote)
    {
     p->cote=cote;
    }
...
int valeur_cote_Livre(maillon_Livre*p)
    {
    return (p->cote);
    }
...
char* valeur_titre_Livre(maillon_Livre*p)
    {
    return (p->titre);
    }
...
char* valeur_auteur_Livre(maillon_Livre*p)
    {
     return (p->auteur);
    }
...
char* valeur_editeur_Livre(maillon_Livre*p)
    {
     return (p->editeur);
    }
...
char* valeur_motCle_Livre(maillon_Livre*p)
    {
     return (p->motCle);
    }
...
char* valeur_resume_Livre(maillon_Livre*p)
    {
     return (p->resume);
    }
...
void aff_ordreInscription_Emprunteur(maillon_Emprunteur*p,int ordreInscription)
    {
...
void aff_dateDeInscription_Emprunteur(maillon_Emprunteur*p,struct date dateDeInscription)
    {
...
void aff_adresseActuelle_Emprunteur(maillon_Emprunteur*p,char adresseActuelle[])
    {
...
int valeur_penalite_Emprunteur(maillon_Emprunteur*p)
    {
     return (p->penalite);
    }
...
char* valeur_nom_Emprunteur(maillon_Emprunteur*p)
    {
     return (p->nom);
    }
...
char* valeur_prenom_Emprunteur(maillon_Emprunteur*p)
    {
     return (p->prenom);
    }
...
void aff_Emprunteur_Emprunt(maillon_Emprunt*p,maillon_Emprunteur* Emprunteur)
    {
...
void aff_livreEmprunte_Emprunt(maillon_Emprunt*p,maillon_Livre* livreEmprunte)
    {
...
int valeur_livreRendu_Emprunt(maillon_Emprunt*p)
    {
     return (p->livreRendu);
    }
...
struct date valeur_dateDeRetour_Emprunt(maillon_Emprunt*p,struct date dateDeRetour)
    {
