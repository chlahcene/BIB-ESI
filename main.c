...
void ChioxMenu(){
    ...
    int c2=4;
    char* C2[] =    {
                      "LISTE DES EMPRUNTEUR TRIE SELON LE NOMBRE D'EMPRUNT",
                      "LISTE DES EMPRUNTEUR",
                      "LISTE DES EMPRUNTEUR PINALISER",
    ...
    char* D1[] =    {
                      "LISTE DES LIVRES",
                      "LIVRES DISPONIBLES",
                      "LIVRES N'EST PAS DISPONIBLES",
                      "LISTE DES LIVRES TRIE SELON LE NOMBRE D'EMPRUNT",
                      "RECHARCHER UN LIVRE"
                     };
    int e1=3;
    char* E1[] =    {
  ...
  if (i==1){
     ...
     if (i==1) {
        ...
        if (i==1) {
            ...
            Eclater2ListeEmprunt(TEmprunt,&TEmpruntEnCours,&TEmpruntTerminer);
